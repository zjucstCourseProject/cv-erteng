...
> 指导教师：刘二腾
>
> language：C++，完整源程序见main1.cpp文件和main2.cpp文件
...
刘老师布置的这几次作业都由很强的实践性，能够让我们实实在在地计算机视觉的方法去解决问题。这几次作业都让我认识到，传统图像和视觉处理是非常严谨且实用的一门学科，只要用心学习必然有非常大的收获。

## 课程总结

课程已经结束了，非常感谢刘老师开了这门课以及老师的教导。后面请的企业老师也是非常专业，讲课非常耐心，讲授理论很清楚，在实践课程时也传授给了同学们很多知识。刘老师的《分布式系统》也是非常好的课程，给我这个非科班学生补充了很多以前不知道的基础知识，谢谢刘老师！